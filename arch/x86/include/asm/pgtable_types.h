 ...
 * _PAGE_PROTNONE avoids trouble with swp entries.
 */
#define _PAGE_NUMA_PTE	_PAGE_PSE
/*
 * Cannot be set on pmd, if hugepages will be swapped the offset must start
 * above it.
 */
#define _PAGE_NUMA_PMD	_PAGE_UNUSED2 /* cannot be set on pte */
