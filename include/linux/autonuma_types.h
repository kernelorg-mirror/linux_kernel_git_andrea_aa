 ...
 * this system. They are linked together in a list headed within the
...
struct mm_autonuma {
	 ...
	 */
#define MM_AUTONUMA_RESET_START mm_numa_fault_pass
	unsigned long mm_numa_fault_pass;
	unsigned long mm_numa_fault_last_pass;
...
struct task_autonuma {
	...
	/*
	 * Zeroed from here during allocation, check
	 * task_autonuma_reset() if you alter the below.
	 */
#define TASK_AUTONUMA_RESET_START task_false_sharing
	bool task_false_sharing;
